...
-- ── TEMA NOVO: semi-transparente + borda RGB + texto lilás ──────────────
local BG      = Color3.fromRGB(10,  10,  18)   -- fundo escuro semi-trans
local SURFACE = Color3.fromRGB(16,  14,  28)   -- card interno
local ACCENT  = Color3.fromRGB(180, 100, 255)  -- lilás
local BORDER  = Color3.fromRGB(180, 100, 255)  -- lilás
local TEXT    = Color3.fromRGB(255, 255, 255)  -- branco puro
local SUBTEXT = Color3.fromRGB(210, 190, 255)  -- lilás claro
local ITEMHOV = Color3.fromRGB(28,  22,  48)   -- hover escuro
local ITEMSEL = Color3.fromRGB(50,  30,  90)   -- selecionado
local BTNRED  = Color3.fromRGB(200, 60,  60)
local BTNGRN  = Color3.fromRGB(50,  200, 100)

-- ── RGB animado na borda principal ──────────────────────────────────────
local _rgbHue = 0
game:GetService("RunService").Heartbeat:Connect(function(dt)
    _rgbHue = (_rgbHue + dt * 0.5) % 1
end)
local function getRGB() return Color3.fromHSV(_rgbHue, 1, 1) end
...
local RARITY_COLORS = {
    ...
    OG                  = Color3.fromRGB(180,100,255),
    Taco                = Color3.fromRGB(180,100,255),
    Admin               = Color3.fromRGB(180,100,255),
    Spooky              = Color3.fromRGB(120,60,200),
    Festive             = Color3.fromRGB(160,80,255),
...
local function SectionHeader(parent,text,yPos)
    New("Frame",{Size=UDim2.new(0,3,0,14),Position=UDim2.new(0,10,0,yPos+2),BackgroundColor3=Color3.fromRGB(180,100,255),BorderSizePixel=0,Parent=parent})
    local _sl = New("TextLabel",{Size=UDim2.new(1,-28,0,18),Position=UDim2.new(0,18,0,yPos),Text=text:upper(),TextColor3=Color3.fromRGB(255,255,255),Font=Enum.Font.GothamBold,TextSize=9,BackgroundTransparency=1,TextXAlignment=Enum.TextXAlignment.Left,Parent=parent})
    TextStroke(_sl, Color3.fromRGB(180,100,255), 1)
end
...
local function Stroke(parent, color, thickness, trans)
    ...
    s.Color = color or BORDER; s.Thickness = thickness or 1.5
    s.Transparency = trans or 0; s.Parent = parent
    return s
end

-- aplica contorno lilás branco em qualquer TextLabel/TextButton
local function TextStroke(lbl, color, thickness)
    local ts = Instance.new("UIStroke")
    ts.Color = color or Color3.fromRGB(180,100,255)
    ts.Thickness = thickness or 1.2
...
Corner(win, 10)
-- borda RGB animada na janela principal
local _winStroke = Stroke(win, Color3.fromRGB(180,100,255), 2, 0)
game:GetService("RunService").Heartbeat:Connect(function()
    if _winStroke and _winStroke.Parent then
        _winStroke.Color = getRGB()
    end
end)
...
Corner(tbar, 10)
New("Frame", {Size=UDim2.new(1,0,0,1), Position=UDim2.new(0,0,1,-1), BackgroundColor3=Color3.fromRGB(60,30,100), BorderSizePixel=0, Parent=tbar})
	do
	    local _tl = New("TextLabel", {
	        Size=UDim2.new(1,-80,1,0), Position=UDim2.new(0,10,0,0),
	        Text="branzZ Trade Script",
	    ...
	    _ts.Color = Color3.fromRGB(180,100,255)
	    _ts.Thickness = 1.5
	    _ts.ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual
	    _ts.Parent = _tl
	end

	local hideBtn = New("TextButton", {
	    Size=UDim2.new(0,30,0,30), Position=UDim2.new(1,-65,0,3),
	    Text="—", TextColor3=Color3.fromRGB(200,180,255), Font=Enum.Font.GothamBold, TextSize=16,
	    BackgroundColor3=Color3.fromRGB(28,20,48), BackgroundTransparency=0.2,
	    Parent=tbar,
	})
	Corner(hideBtn, 8)
	Instance.new("UIStroke", hideBtn).Color = Color3.fromRGB(100,60,180)
	hideBtn.MouseButton1Click:Connect(function()
	    sg.Enabled = false
	end)

	local closeBtn = New("TextButton", {
	    Size=UDim2.new(0,30,0,30), Position=UDim2.new(1,-33,0,3),
	    Text="✕", TextColor3=Color3.fromRGB(255,100,100), Font=Enum.Font.GothamBold, TextSize=14,
	    BackgroundColor3=Color3.fromRGB(50,18,18), BackgroundTransparency=0.15,
	    Parent=tbar,
	})
	Corner(closeBtn, 8)
	Instance.new("UIStroke", closeBtn).Color = Color3.fromRGB(100,30,30)
...
Corner(tabBar, 10)
Instance.new("UIStroke", tabBar).Color = Color3.fromRGB(60,30,100)
do
...
local function MakeTab(label, order)
    local btn = New("TextButton", {
        ...
        BackgroundColor3=Color3.fromRGB(18,14,35),
    ...
    bst.Color = Color3.fromRGB(100,55,180) bst.Thickness = 1
    -- contorno lilás no texto da aba
    local tst = Instance.new("UIStroke")
    tst.Color = Color3.fromRGB(180,100,255)
    tst.Thickness = 1.2
...
do
    ...
    local spawnBtn = New("TextButton", {
        Size=UDim2.new(1,0,0,40), BackgroundColor3=Color3.fromRGB(60,30,110),
    ...
    spawnBtn.MouseLeave:Connect(function() spawnBtn.BackgroundColor3=Color3.fromRGB(60,30,110) end)
    ...
    do
        ...
        local skinApplyBtn = New("TextButton", {
            Size=UDim2.new(1,0,0,32), BackgroundColor3=Color3.fromRGB(60,30,110),
        ...
        skinApplyBtn.MouseLeave:Connect(function() skinApplyBtn.BackgroundColor3=Color3.fromRGB(60,30,110) end)

        local skinRemoveBtn = New("TextButton", {
            Size=UDim2.new(1,0,0,32), BackgroundColor3=Color3.fromRGB(50,18,18),
        ...
        skinRemoveBtn.MouseLeave:Connect(function() skinRemoveBtn.BackgroundColor3=Color3.fromRGB(50,18,18) end)
    ...
    do
        ...
        function _openSignEditor()
            ...
            saveBtn.MouseLeave:Connect(function() saveBtn.BackgroundColor3 = Color3.fromRGB(60,30,110) end)
        ...
        OpenFakeTradeSetup = function(prefill)
            ...
            local popBtn = New("TextButton", {
                ...
                BackgroundColor3=Color3.fromRGB(40,20,80), Text="Pop Out",
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
            ...
            popBtn.MouseLeave:Connect(function() popBtn.BackgroundColor3 = Color3.fromRGB(40,20,80) end)
            ...
            local function refreshIgnoreBtn()
                ...
                ignoreBtn.BackgroundColor3 = ignoreHide
                    and Color3.fromRGB(60,30,110) or Color3.fromRGB(30,20,50)
            end
            ...
            local addBtn = New("TextButton", {
                ...
                BackgroundColor3=Color3.fromRGB(60,30,110), Text="+ ADD",
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
            ...
            local launchBtn = New("TextButton", {
                ...
                BackgroundColor3=Color3.fromRGB(80,40,180), Text="LAUNCH",
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
            ...
            launchBtn.MouseLeave:Connect(function() launchBtn.BackgroundColor3=Color3.fromRGB(80,40,180) end)
            y = y + 44
            local notifBtn = New("TextButton", {
                Size=UDim2.new(1,-pad*2,0,32), Position=UDim2.new(0,pad,0,y),
                BackgroundColor3=Color3.fromRGB(50,25,100), Text="Trade Notification",
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
                TextSize=14, AutoButtonColor=false, BorderSizePixel=0, Parent=win2,
            })
            Corner(notifBtn, 6)
            notifBtn.MouseEnter:Connect(function() notifBtn.BackgroundColor3=Color3.fromRGB(90,160,230) end)
            notifBtn.MouseLeave:Connect(function() notifBtn.BackgroundColor3=Color3.fromRGB(50,25,100) end)
            ...
            local forceBtn = New("TextButton", {
                Size=UDim2.new(1,-pad*2,0,32), Position=UDim2.new(0,pad,0,y),
                BackgroundColor3=Color3.fromRGB(60,30,110), Text="Force Accept",
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
                TextSize=14, AutoButtonColor=false, BorderSizePixel=0, Parent=win2,
            })
            Corner(forceBtn, 6)
            forceBtn.MouseEnter:Connect(function() forceBtn.BackgroundColor3=Color3.fromRGB(60,180,90) end)
            forceBtn.MouseLeave:Connect(function() forceBtn.BackgroundColor3=Color3.fromRGB(60,30,110) end)
